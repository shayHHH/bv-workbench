...
| 待审核 | 材料已提交，等待合规官审核 | 合规驳回并要求补件 | 被驳回 |
| 待审核 | 材料已提交，等待合规官审核 | 合规审核驳回 | 审核拒绝 |
| 被驳回 | 合规要求补充或修改材料 | 补充材料并重新提交 | 待审核 |
| 被驳回 | 合规要求补充或修改材料 | 长时间未补件或客户放弃，交易员取消 | 已取消 |
...
| KYC被驳回 | 被驳回或审核拒绝 | 交易员重新提交审核到合规 | 合规审核中 |
...
3. 审核拒绝和被驳回是否需要同时存在，还是统一成一个“驳回待处理”状态。
